...
- 9:10am:  **HyperTuner: Visual Analytics for Hyperparameter Tuning by Professionals**
![PDF Logo][logo] by Tianyi Li, Gregorio Convertino, Wenbo Wang, Haley Most, Tristan Zajonc, Yi-Hsun Tsai (paper)
- 9:20am:  **Computer-supported Interactive Assignment of Keywords for Literature Collections**
![PDF Logo][logo] by Shivam Agarwal, Jürgen Bernard, Fabian Beck (paper)
- 9:30am:  **Using Hidden Markov Models to Determine Cognitive States of Visual Analytic Users**
![PDF Logo][logo] by Mohamad Aboufoul, Ryan Wesslen, Isaac Cho, Wenwen Dou, Samira Shaikh (paper)
- 9:40am:  **Providing Contextual Assistance in Response to Frustration in Visual Analytics Tasks**
![PDF Logo][logo] by Prateek Panwar, Adam Bradley, Christopher Collins (paper)
- 9:50am:  **Interactive Machine Learning Heuristics** 
![PDF Logo][logo] by Eric Corbett, Nathaniel Saul, Meg Pirrung (poster)
- 9:55am:  **Opening the Black-Box: Towards more Interactive and Interpretable Machine Learning** 
![PDF Logo][logo] by Fabian Peña, John Guerra-Gomez (poster)
...
- 11:00am:  **ModelSpace: Visualizing the Trails of Data Models in Visual Analytics Systems** 
![PDF Logo][logo] by Eli Brown, Sriram Yarlagadda, Kristin Cook, Remco Chang, Alex Endert (paper)
- 11:10am:  **A Human-in-the-Loop Software Platform** by Fang Cao, David Scroggins, Lebna Thomas, Eli Brown (paper)
- 11:20am:  **A Bidirectional Pipeline for Semantic Interaction** 
![PDF Logo][logo] by Michelle Dowling, John Wenskovitch, Peter Hauck, Adam Binford, Nicholas Polys, Chris North (paper)
- 11:30am:  **Speculative Execution for Guided Visual Analytics** 
![PDF Logo][logo] by Fabian Sperrle, Jürgen Bernard, Michael Sedlmair, Daniel Keim, Mennatallah El-Assady (paper)
