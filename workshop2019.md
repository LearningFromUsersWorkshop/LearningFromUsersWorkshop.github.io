...
- 3:15pm:  **"All Right, Mr. DeMille, I'm Ready for My Closeup": Adding Meaning to User Actions from Video for Immersive Analytics** by Andrea Batch, Niklas Elmqvist
...
- 4:40pm:  **DeepVA: Bridging Cognition and Computation through Semantic Interaction and Deep Learning** by Yali Bian, John Wenskovitch, Chris North
- 4:55pm:  **Machine Learning from User Interaction for Visualization and Analytics:  A Workshop-Generated Research Agenda** by John Wenskovitch, Michelle Dowling, Laura Grose, Remco Chang, Alex Endert, David H. Rogers
- 5:05pm:  **Lightning Talks & Discussion** -- [Submit a Talk](https://forms.gle/xZCnXVmh7spLkGJSA)
- 5:30pm:  **Next Steps**
